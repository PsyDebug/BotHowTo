...
* У вас уже есть telegram бот на perl и вы подумывали переделать его на WebHook.
...
Далее создадим самого бота, если этого ещё не сделали. 
...
2. Передача на выполнение функции, соответствующую запросу от пользователя  
